...
echo "Do you want to restore to the NEWER emoji?(y/n)"
...
if [ "${answer,,}" = "y" ]; then
    ...
    sudo cp -rf ../face_config_bak.json ${HOME}/Library/Containers/com.tencent.qq/Data/Library/Application\ Support/QQ/global/nt_data/Emoji/emoji-resource/sysface_res/face_config.json
    # Restoring emoji config zip file
    sudo cp -rf ../face_config.json_bak.zip ${HOME}/Library/Containers/com.tencent.qq/Data/Library/Application\ Support/QQ/global/nt_data/Emoji/emoji-resource/sysface_res/face_config.json.zip
    echo "Done!"
else
    echo "Aborted!"
fi